...
var links_from_post_id_query_format =  "select distinct l.from_post_id, p.id as to_post_id, p.title, p.uri, l.id from links l join posts p on l.uri = p.uri order by l.id DESC limit 1";
